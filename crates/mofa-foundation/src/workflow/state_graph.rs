    ...
    async fn stream(
        ...
        tokio::spawn(async move {
            ...
            while !current_nodes.is_empty() {
                ...
                // Retrieve next nodes
                // Command has targeted targets, which we don't have get_next_nodes for easily here without code repetition in stream
                // For now, break if we don't have logic, or try to apply logic similarly to step/invoke.
                // To clear the exact compiler error and make it logical:
                // TODO: Implement proper edge following for stream.
                // For now, clear current_nodes to break gracefully instead of an unconditional break.
                current_nodes.clear();
            }
