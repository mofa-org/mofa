...
///
/// ```rust,ignore
/// use mofa_runtime::agent::registry::{AgentFactory, AgentConfig};
///
/// struct LLMAgentFactory;
///
/// #[async_trait]
/// impl AgentFactory for LLMAgentFactory {
///     async fn create(&self, config: AgentConfig) -> AgentResult<Arc<RwLock<dyn UnifiedAgent>>> {
///         let agent = LLMAgentAdapter::from_config(config)?;
...
///
/// ```rust,ignore
/// use mofa_runtime::agent::registry::{AgentRegistry, AgentConfig};
///
