...
> 参见 [CONTRIBUTING.md](https://github.com/mofa-org/mofa/blob/main/CONTRIBUTING.md) 了解编辑代码前需要知道的架构规则。
...
完整列表示例参见 [examples/README.md](https://github.com/mofa-org/mofa/blob/main/examples/README.md)。
